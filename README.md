...
16. Launch VSCode
    ...
    - Open one of the .sol files, right click the code and click _Solidity: Change Workspace compiler version (Remote)_, Change to 0.8.5
      ...
      - Otherwise choose the Workspace tab
        - Search for _Solidity_ and copy and paste _v0.8.5_ into the _Solidity: Compile Using Remote Version_ textbox

...
def test_reject_ether(gov, vault):
    ...
    for func, args in [
        ...
        ("withdraw", ["0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2"]),
        ("deposit", ["0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2", 1]),
        ("withdraw", ["0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2", 1]),
